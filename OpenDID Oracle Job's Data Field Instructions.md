...
The application system can integrate the official SDK provided by Terminal3, generate Oracle Request Data by calling the `makeEncryptdSignedFetchRequest` function, and call OpenDID Oracle to obtain the corresponding ciphertext data for the user.
...
- Reference: Terminal3 Identity [Get User Profile (encrypted from end user)](https://terminal3.readme.io/reference/get-user-profile-encrypted-from-end-user) function.

- Oracle Request Data:

|           Name                |       Type      |      Required      |                     Description               |
| ------------------| ----------|----------| ----------------------|
| `version`                    | string           |       Y         |    Version number         |
| `nonce`                    | string           |       Y         |    Nonce          |
| `ephem_public_key`                    | string           |       Y         |    Ephem public key          |
| `ciphertext`                    | string           |       Y         |    Encrypted signature value         |
...
| `nonce`                    | string           |       Y         |    Nonce          |
| `ephem_public_key`                    | string           |       Y         |    Ephem public key          |
| `ciphertext`                    | string           |       Y         |    Ciphertext data          |
...
- Reference: Terminal3 Identity official contract `issuers` function.
